...
- **Dépôt GitHub :** https://github.com/Manu0042/zoe-charge-calculator
- **Application (installation Android) :** https://manu0042.github.io/zoe-charge-calculator
...
### Étape 1 — Héberger les fichiers sur GitHub Pages

1. Créez un nouveau dépôt public sur [github.com](https://github.com/new)
2. Uploadez les fichiers du dossier `zoe-pwa/` à la racine du dépôt (ou via `git push`)
3. Allez dans **Settings → Pages**
4. Sous *Branch*, sélectionnez `main` et le dossier `/ (root)`, puis cliquez **Save**
5. GitHub génère une URL du type `https://votre-pseudo.github.io/nom-du-repo`

> La mise en ligne prend généralement 1 à 2 minutes après le premier push.
